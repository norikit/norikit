<!-- DO NOT EDIT — generated mirror of noripad/ai-docs/architecture.md by tools/aggregate_docs.py. Edit the source. -->

# Architecture

The evolving system design for noripad — modules, data flow, threading, and any
...
- `Sources/noripad/<Layer>/` — <responsibility>
-->
