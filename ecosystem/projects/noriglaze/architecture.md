<!-- DO NOT EDIT — generated mirror of noriglaze/ai-docs/architecture.md by tools/aggregate_docs.py. Edit the source. -->

# Architecture

The evolving system design for noriglaze — modules, data flow, threading, and any
...
- `Sources/noriglaze/<Layer>/` — <responsibility>
-->
