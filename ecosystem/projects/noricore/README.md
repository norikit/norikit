<!-- DO NOT EDIT — generated mirror of noricore/ai-docs/README.md by tools/aggregate_docs.py. Edit the source. -->

# noricore knowledge base

This directory is the **single source of truth** for noricore's design intent and project
...
| [architecture.md](architecture.md) | The evolving system design — modules, data flow, threading. |
